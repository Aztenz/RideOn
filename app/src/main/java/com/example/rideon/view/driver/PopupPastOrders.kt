...
import com.example.rideon.adapters.profile_fragment.PastOrdersAdapter
import com.example.rideon.model.database.RoutesManager
import com.google.android.material.bottomsheet.BottomSheetDialogFragment
import java.util.Date

class PopupPastOrders : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.popup_past_orders, container, false)
        val pastOrdersRecycler: RecyclerView = view.findViewById(R.id.recycler_past_orders)
        pastOrdersRecycler.adapter = PastOrdersAdapter(rideList)
        return view
    }
}
